...
const multiSelectVariants = cva("m-1 transition-all duration-300 ease-in-out", {
	variants: {
		variant: {
			default: "border-gray-200 text-gray-800 bg-white hover:bg-gray-50", // Màu trắng
				...
				<Popover
					...
					<PopoverTrigger asChild>
						<Button
                            ...
                            className={cn(
                                "flex px-3 py-2 rounded-md border border-gray-200 h-10 items-center justify-between bg-white hover:bg-gray-50 [&_svg]:pointer-events-auto", // Thay đổi p-1 thành px-3 py-2 và min-h-10 thành h-10
                                autoSize ? "w-auto" : "w-full",
                                responsiveSettings.compactMode && "h-8 text-sm px-2 py-1", // Thay đổi min-h-8 thành h-8
                                screenSize === "mobile" && "h-12 text-base", // Thay đổi min-h-12 thành h-12
								...
								<div className="flex justify-between items-center w-full">
									<div
										...
										{selectedValues.length > responsiveSettings.maxCount && (
											<Badge
                                            className={cn(
                                                "bg-white text-gray-700 border-gray-200 hover:bg-gray-50", // Thêm màu trắng
                                                getBadgeAnimationClass(),
                                            ...
                                            <XCircle
                                                className={cn(
                                                    "ml-2 h-4 w-4 cursor-pointer text-gray-500 hover:text-gray-700", // Thêm màu cho icon
					...
					<PopoverContent
						...
						className={cn(
                            "w-auto p-0 bg-white border border-white-200", // Thêm bg-white và border
